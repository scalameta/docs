...
<Tip>
  Latest release: <strong id="metals-version" style={{ cursor: "pointer" }} title="Click to copy">2.0.0-M2</strong><span id="metals-release-date-wrapper" style={{ display: "none" }}> (released <span id="metals-release-date"></span>)</span>
</Tip>
