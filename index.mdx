...
Traditional Java and Scala IDEs depend on syncing with your build tool to understand the
project structure. This sync is a blocking operation—often taking minutes on
...
Metals v2 indexes source files directly, bypassing the build for core navigation.
Open a 10-million-line folder and get working go-to-definition in under 20
seconds—no build server required, no need for the code to compile first.
