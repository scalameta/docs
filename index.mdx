...
navigation.  Open a 10-million-line folder and get working
find-implementations in under 20 seconds — no build server required,
no need for the code to compile first.
